<template>
  <div>
    ...
    <ToggableSection title="Display" id="trades-display" inset>
      <div
      ...
      >
        <label class="-fill -center -inline">Filter by type</label>
        <div
        ...
        >
          ...
          <div
            :on="
              tradeType === 'liquidations' ? 'Liquidations only' : 'Trades only'
            "
      ...
      >
        <label class="-fill -center -inline">Show exchange's logos</label>
        <div
          class="checkbox-control -auto checkbox-control-input -unshrinkable"
      ...
      >
        <label class="-fill -center -inline">Columns</label>
        <div
          class="checkbox-control -auto checkbox-control-input -unshrinkable"
      ...
      <div
        ...
        @click.stop="$store.commit(paneId + '/TOGGLE_PRICE')"
      >
        <label class="-fill -center -inline">Name</label>
        <div
          class="checkbox-control -auto checkbox-control-input -unshrinkable"
        >
          <input type="checkbox" class="form-control" :checked="showPrice" />
